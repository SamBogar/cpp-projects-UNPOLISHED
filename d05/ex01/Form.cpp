...
/*   Updated: 2017/07/11 18:58:56 by sbogar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form( Form const &src ): name(src.get_name()), is_signed(src.get_is_signed()), \
								sign_grade(src.get_sign_grade()), exec_grade(src.get_exec_grade())
{
}

Form::Form( std::string _name, int _sign_grade, int _exec_grade ): name(_name), is_signed(0), \
